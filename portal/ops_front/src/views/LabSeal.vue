...
const { labSealList, getLabSealList } = useApi();
...
<template>
  <div class="min-h-full bg-gray-100 flex flex-col justify-center py-5 px-6 lg:px-8">
        ...
        <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Lab Seal</h2>
     <!-- Table -->
    <div class="flex items-center justify-center">
      <table class="border-collapse border-2 border-gray-500">
        ...
        <tbody>
          <tr v-for="order in labSealList" v-bind:key="order.id">
