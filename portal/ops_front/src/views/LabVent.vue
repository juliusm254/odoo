...
const { labVentList, getLabVentList } = useApi();
...
<template>
  <div class="min-h-full bg-gray-100 flex flex-col justify-center py-5 px-6 lg:px-8">
        ...
        <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Lab Vent List</h2>
     <!-- Table -->
    <div class="flex items-center justify-center">
      <table class="border-collapse border-2 border-gray-500">
        ...
        <tbody>
          <tr v-for="order in labVentList" v-bind:key="order.id">
