...
class PropertyProperty(models.AbstractModel):
    ...
    base_equipment_id = fields.Many2one(
        "maintenance.equipment", required=True, ondelete="restrict"
    )
    ...
    acquisition_mode_id = fields.Many2one(
        "property.acquisition", string="Acquisition Mode"
    )
    ...
    doc_count = fields.Integer(
        string="Number of documents", compute="_compute_attached_docs"
    )
