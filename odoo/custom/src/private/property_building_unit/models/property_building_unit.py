...
class RentalUnit(models.Model):
    ...
    related_property_id = fields.Many2one(
        "property.property",
        string="Property",
        required=False,
        default=None,
    ...
    #         if self.partner_id:
    #             self.env["property.stakeholder"].write({
    #                 "partner_id": self.partner_id.id,
    #                 "property_id": self.related_property_id.id,
    #                 "partner_status": "tenant",
    #             })
...
class PropertyBuildingUnit(models.Model):
    _description = "Property Building Units"
